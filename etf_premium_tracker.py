...
WATCHLIST = [
    ...
    ("NIFTYBEES", "NIFTYBEES.NS", "Nippon India ETF Nifty 50"),
    ("MIDCAPETF", "MIDCAPETF.NS", "Nippon India ETF Nifty Midcap 150"),
    ("SILVERBEES", "SILVERBEES.NS", "Nippon India Silver ETF"),
]
